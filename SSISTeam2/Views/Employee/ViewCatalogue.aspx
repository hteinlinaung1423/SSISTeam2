...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1"
 ...
 <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <h2>
                    <asp:Label ID="Label2" runat="server" Text="View Catalogue"></asp:Label></h2>
            </div>
