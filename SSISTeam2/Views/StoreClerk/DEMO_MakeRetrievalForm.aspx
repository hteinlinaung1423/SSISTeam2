<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DEMO_MakeRetrievalForm.aspx.cs" Inherits="SSISTeam2.Views.StoreClerk.MakeRetrievalForm" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="panelNormal" runat="server">
            <asp:Button ID="btnSubmit" runat="server" Text="Make Retrieval form" OnClick="btnSubmit_Click" />
        </asp:Panel>
    </div>
    </form>
</body>
