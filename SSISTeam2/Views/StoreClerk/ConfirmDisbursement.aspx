<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmDisbursement.aspx.cs" Inherits="SSISTeam2.Views.StoreClerk.ConfirmDisbursement" %>
    ...
    <div>
        ...
        <asp:Panel ID="panelNoItems" runat="server">
                ...
                <asp:Panel ID="panelNormal" runat="server">
                    <asp:Button ID="btnSubmit" runat="server" Text="Confirm disbursed quantities" OnClick="btnSubmit_Click" />
                </asp:Panel>
    </form>
</body>
</html>
